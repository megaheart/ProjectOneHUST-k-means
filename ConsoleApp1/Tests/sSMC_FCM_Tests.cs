...
{
    public static class sSMC_FCM_Tests
    {
        public static void SSMC_FCM_WithTrial_Benchmark()
        {
            ...
            foreach (var dataInfo in Data.datas)
            {
                ...
                var fcm = new sSMC_FCM_Trial(data.X, data.C, 5, data.expect, 100);
                fcm._solve();
                var mc_fcm = new sSMC_FCM_Trial(data.X, data.C, 10, data.expect, 100);
                mc_fcm._solve();
                var mc_fcm2 = new sSMC_FCM_Trial(data.X, data.C, 15, data.expect, 100);
                mc_fcm2._solve();
                var mc_fcm3 = new sSMC_FCM_Trial(data.X, data.C, 20, data.expect, 100);
                mc_fcm3._solve();
                var mc_fcm4 = new sSMC_FCM_Trial(data.X, data.C, 0, data.expect, 100);
                mc_fcm4._solve();
